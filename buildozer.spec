...
source.include_exts = py,png,jpg,kv,atlas,os,c,h
...
requirements = python3,kivy==2.2.1,kivymd,pygments,numpy,soundfile,pygame
...
icon.filename = %(source.dir)s/br512.png
